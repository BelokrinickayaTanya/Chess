...
Основные методы и и конствукторы классов: конструктор, который принимает цвет фигуры; метод getColor(), который возвращащает цвет фигуры; метод canMoveToPosition(), который проверяет границы доски и реализует основную логину хода фигу; метод getSymbol(), который возвращает символ фигуры,
